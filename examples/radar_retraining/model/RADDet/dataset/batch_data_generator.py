...
class DataGenerator:
    def __init__(self, config_data, config_train, config_model, headoutput_shape,
        ...
        self.total_train_batches = (self.config_train["epochs"] * len(
            self.RAD_sequences_train)) // self.batch_size
    ...
    def encodeToLabels(self, gt_instances):
        ...
        for i in range(len(gt_instances["classes"])):
            ...
            if np.any(iou_mask):
                ...
                if xind < 16 and yind < 16 and zind < 4:
    ...
    def trainData(self, ):
        ...
        while count < len(self.RAD_sequences_train):
            ...
            RAD_complex = loader.read_rad(RAD_filename)
        ...
        return tf.data.Dataset.from_generator(self.trainData,
                                              ...
                                              output_shapes=(
                                                  ...
                                                  tf.TensorShape(
                                                      ...
                                                      [len(self.anchor_boxes),
                                                       7 + len(self.config_data[
                                                                   "all_classes"])]),
                                                  tf.TensorShape(
                                                      [self.config_data["max_boxes_per_frame"],
                                                       7])
                                              ), )
