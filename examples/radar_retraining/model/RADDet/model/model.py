...
import model.RADDet.model.backbone_radarResNet as radarResNet
import model.RADDet.model.head_YOLO as yolohead
import model.RADDet.model.loss_functions as loss_func
import numpy as np
...
class RADDet(K.Model):
    ...
    def decodeYolo(self, yolo_raw):
        pred_raw, pred = yolohead.boxDecoder(yolo_raw, self.input_size,
                                             self.anchor_boxes, self.num_class,
                                             self.yolohead_xyz_scales[0])
