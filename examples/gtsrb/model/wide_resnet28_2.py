...
class WideResNet(nn.Module):
    ...
    """
    model_relative_path = "bin/gtsrb_training/wide_resnet28_2"
    ...
    def load_model(cls, model_category) -> WideResNet:
        ...
        model = cls(depth=28, widen_factor=2, dropout_rate=0, num_classes=43)
    ...
    def evaluate_image(self, img: ndarray) -> int:
        ...
        tensor_img = tensor_img.to(torch.device(device))
