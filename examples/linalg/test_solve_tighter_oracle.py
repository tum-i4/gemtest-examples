...
# To get a tighter oracle we check if the two vectors are equal
...
def equal_vector_relation(source_input: np.ndarray, followup_output: np.ndarray) -> bool:
    return bool(np.allclose(source_input, followup_output))
